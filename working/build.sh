...
clang++ -pedantic-errors -Wall -std=c++14 *.c++ ./draw/*.c++ ./initial/checkBoundsOfBounds/*.c++ ./initial/collapse/*.c++ ./initial/load/*.c++ ./physics/*.c++ ./sprite/player/*.c++ ./sprite/*.c++ -lncurses
