...
clang++ -ggdb3 -pedantic-errors -Wall -std=c++14 *.cpp ./draw/*.cpp ./initial/checkBoundsOfBounds/*.cpp ./initial/collapse/*.cpp ./initial/load/*.cpp ./io/*.cpp ./physics/*.cpp ./sprite/player/*.cpp ./sprite/*.cpp -lncurses
#remove crud >:(
